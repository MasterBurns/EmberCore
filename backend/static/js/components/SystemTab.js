...
export default {
    ...
    </div> <div class="bg-gray-950 p-6 rounded-xl border border-gray-900 shadow-xl space-y-5">
    ...
    </div> </div> <div class="bg-gray-950 p-6 rounded-xl border border-gray-900 shadow-xl space-y-5 flex flex-col justify-between">
    <div>
    ...
    </div> <div class="col-span-1 md:col-span-2 bg-gray-950 p-6 rounded-xl border border-gray-900 shadow-xl flex flex-col h-96">
